...
public class CoffeeShop {
	...
	public static void main(String[] args) {
		...
		String menu = "";
		System.out.println("A: 아메리카노, M: 카페모카, C: 카라멜마키아또, T: 오늘의 커피");
		System.out.print("> ");
		menu = sc.next(); 
		//amenu = menu.toUpperCase(); //문자를 대문자로 변경
		//toLowerCase()문자를 소문자로 변경
		
		
		//System.out.println("입력한 값:" + menu);
		//System.out.println("입력한 메뉴: " + menu.toUpperCase());
		switch(menu) {
			case "A":
			case "a":
			...
			case "C":
			case "c":
				System.out.println("카라멜마키아또를 주문하셨습니다.");
				break;
			case "T":
			case "t":
